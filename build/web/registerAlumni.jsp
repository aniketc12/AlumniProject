...
<div class="row">
    <center><h1>Create your Alumni account</h1></center>
    <div class="col-sm-4">
<img class="img-responsive" src="img/signup.png" alt="Sign Up" width="460" height="345">
    ...
    <div class="col-sm-6"  >
        ...
        <div class="container" class="control-label col-sm-4 row-sm-4" >
            <br><br>
  <form class="form-horizontal" method="post" action="verifyAlumni.jsp" onsubmit="return myFunction()">
      <div class="form-group">
      <label class="control-label col-sm-2" for="rollNo">Batch of:</label>
      <div class="col-sm-2" id="rollN">
        <input type="text" class="form-control" id="rollNo" name="batch" placeholder="Enter Roll No" required>
      </div>
    </div>
      ...
      <div class="control-label col-sm-3">
              <label for="house" >Enter the house you were in:</label>
      </div>
